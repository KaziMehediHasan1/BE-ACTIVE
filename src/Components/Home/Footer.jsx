        ...
        <div>
          ...
          <div className="px-4 py-6 font-Fraunces bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            ...
            <div className="flex font-Fraunces mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              <Link
                className="text-gray-400 font-Fraunces hover:text-gray-900 dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                ...
                <span className="sr-only font-Fraunces">Facebook page</span>
              </Link>
              <Link
                className="text-gray-400 font-Fraunces hover:text-gray-900 dark:hover:text-white"
              >
                ...
                <span className="sr-only font-Fraunces">Discord community</span>
              </Link>
              <a
                href="#"
                className="text-gray-400 font-Fraunces hover:text-gray-900 dark:hover:text-white"
              >
                ...
                <span className="sr-only font-Fraunces">Twitter page</span>
              </a>
              <Link
                className="text-gray-400 hover:text-gray-900 font-Fraunces dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                ...
                <span className="sr-only font-Fraunces">GitHub account</span>
              </Link>
              <Link
                className="text-gray-400 hover:text-gray-900 font-Fraunces dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4 font-Fraunces"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                ...
                <span className="sr-only font-Fraunces">Dribbble account</span>
              </Link>
            </div>
          </div>
        </div>
