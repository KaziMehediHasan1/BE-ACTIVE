...
const Footer = () => {
  return (
    <footer className="bg-blue-200 dark:bg-gray-900 mt-2">
      <div className="grid grid-cols-2 gap-10 px-8 py-6 lg:py-8 md:grid-cols-4">
        <div>
      ...
      <div className="px-8 py-6  bg-blue-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-xl  dark:text-gray-300 sm:text-center">
          © 2024 Be Active All Rights Reserved.
        </span>
